...
public class Rating {
    ...
    public void sendPostHTTPRequestRating() {
        ...
        SerenityRest.given().header("Authorization", "Bearer "
                ...
                .body(requestBody.toJSONString()).post(setPostApiEndpointRating()).then().statusCode(200);
    }
    ...
    public void sendPostHttpRequestRating2() {
        ...
        SerenityRest.given().header("Authorization", "Bearer "
                + "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJGdWxsbmFtZSI6IkFkaXR5YSBOdWdyYWhhIiwiRW1haWwiOiJhZGl0QGdtYWlsLmNvbSJ9.VM2lARkmmliu1pWtk1uhb8z5fGaElvH1jIoYM72Te3g")
                .body(requestBody.toJSONString()).post(setPostApiEndpointRating2()).then().statusCode(500);
    }
