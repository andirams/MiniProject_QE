Feature: Product
    ...
    Scenario: POST - Add new product without fill description
        Given I set POST api endpoints product
        When I send POST HTTP request product3
        Then I receive valid HTTP response code 200 product

    Scenario: POST - Add new product without fill price
        Given I set POST api endpoints product
        When I send POST HTTP request product4
    ...
    Scenario: GET - Get product by invalid ID
